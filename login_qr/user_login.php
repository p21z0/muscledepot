...
<head>
    ...
    <title>MuscleDep0t User login</title>
...
<div class="container-fluid" align=center style="height: 100%;"> 
    ...
    <div class="card shadow-lg" style="width: 45rem; margin: 3% 0% 3% 0%; background: #ea5614; min-height:750px">
        ...
        <div class="card-body bg-white">
            <h2 class="card-title" style="color: #000;">MuscleDep0t User login</h2>
            <?php
                ...
                if (isset($_SESSION['login'])){
                    if ($_SESSION['login']==3){
                        echo "
                            <div class='card mt-4 py-3 border-bottom-success'>
                                <div class='card-body text-danger'>
                                <b>PASSWORD CHANGED SUCESSFULLY. PLEASE RELOGIN</b>
                                </div>
                            </div>";
                            unset($_SESSION['login']);
                            session_destroy(); 
            ...
            ?>
            <form method=post action="user_login_proc.php">
