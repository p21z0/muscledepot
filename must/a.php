<?php
	...
	if ($_SESSION['username']=="") {
		header("Location: ../login/logout_proc.php");
	}
?>
<!DOCTYPE html>
<html lang="en">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" style="background: #EA5614;" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">MuscleDep0t</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="../timelogs/time_in">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="../template/img/undraw_posting_photo.svg">
                            </a>
                ...
                <!-- End of Topbar -->
<!-- <?=$_SERVER['DOCUMENT_ROOT']."/MuscleDepot/template/css/sb-admin-2.min.css"."xxxukinang"?> -->