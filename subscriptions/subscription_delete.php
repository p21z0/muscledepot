    ...
    <div class="container-fluid">
        ...
        <div class="card shadow w-50" style="border:none;">
            ...
            <div class="card-body">
                ...
                <br>
                <i><a href="subscription_delete_proc.php?id=<?= $subscription_id?>&id2=<?= $user_id_2?>" class="btn btn-success btn-icon-split btn-md">
                ...
                &nbsp;&nbsp;&nbsp;
                <a href="user_subscriptions.php?id=<?= urlencode($user_id_2)?>" class="btn btn-danger btn-icon-split btn-md">
                    <span class="icon text-white-50">
