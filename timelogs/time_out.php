  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <?php
              ...
              $timelogs_data=get_where_double("tbl_timelogs", "time_day", $date_today, "timelog_type", "time out");
              // echo $date_today;
        ...
        <form action="time_out_proc.php" method="post" class="scan qrcode" class="form-horizontal">
